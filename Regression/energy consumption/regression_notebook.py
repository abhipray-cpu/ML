...
data_set=generate_data('/content/energydata_complete.csv')
data=data_set['data']
...
raw_data=pd.read_csv('/content/energydata_complete.csv')
...
data_ready=split_data(data,'rv1')
