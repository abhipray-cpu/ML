...
data_set=generate_data('/content/Nutrition__Physical_Activity__and_Obesity_-_Behavioral_Risk_Factor_Surveillance_System.csv')
data=data_set['data']
...
data=preprocess_data(data,'Data_Value')
data.head()
...
raw_data=pd.read_csv('/content/Nutrition__Physical_Activity__and_Obesity_-_Behavioral_Risk_Factor_Surveillance_System.csv',engine='python')
create_heat_map(raw_data)

data.head()
data.drop('Data_Value_Unit', inplace=True, axis=1)
